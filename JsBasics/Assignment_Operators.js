...
4.console.log(10 > 5 > 1); //false
5.let a = 2;
    let b = a++ + ++a; //-- left to right evaluation of exprtession
    console.log(a, b); //4 6

6.let a = 3;
console.log(a++ + a++ + ++a); //13 -- left to right evaluation of exprtession

7.console.log(5 * 2 == "10"); //true
